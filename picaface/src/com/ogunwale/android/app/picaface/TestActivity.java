...
public class TestActivity extends Activity {
	...
	private class GetAlbumsTask extends TimerTask {
		@Override
		public void run() {
			PicasaAuth.refreshAuthToken(getApplicationContext());
			...
			HttpRequestFactory factory = transport.createRequestFactory(new HttpRequestInitializer() {
				...
				public void initialize(HttpRequest request) throws IOException {
					...
					headers.setGoogleLogin(PicasaAuth.getAuthToken());
			...
			try {
				...
				if (feed.albums != null) {
					for (AlbumEntry album : feed.albums) {
						...
						// Log.i("Total number of photos: " + album.numPhotos);
						...
						// Log.i("Image URL: " + photo.mediaGroup.content.url);
						// }
					}
				}
